...
namespace CloudflaredMonitor
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // All buttons start ENABLED so they are always clickable.
            // Each handler guards itself with HasToken()/TunnelId checks and
            // shows a friendly message if prerequisites aren't met.
            ...
            this.lblVersion.Location = new Point(14, 400);
            ...
            this.chkShowToken.Location = new Point(520, 38);
            this.chkShowToken.Size = new Size(52, 18);
            ...
            // ── Status card
            this.pnlStatusCard.Location = new Point(12, 100);
            ...
            this.tblStatus.ColumnCount = 4; this.tblStatus.RowCount = 2;
...
namespace CloudflaredMonitor
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ALL buttons start enabled. Each handler validates prerequisites
            // and shows a friendly message if they are not met.
            this.btnRefresh.Text = "⟳  Check Service Status";
            this.btnRefresh.Location = new Point(12, 130);
            this.btnRefresh.Size = new Size(200, 40);
            this.btnRefresh.Click += new EventHandler(this.btnRefresh_Click);
            ...
            this.colCloud.Text = "Cloud Endpoint"; this.colCloud.Width = 380;
            this.colLocal.Text = "Local Endpoint"; this.colLocal.Width = 340;
