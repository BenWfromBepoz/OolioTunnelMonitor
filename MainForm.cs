...
namespace CloudflaredMonitor
{
    ...
    internal sealed class RoundedPanel : Panel
    {
        ...
        private static readonly Color _bg = Color.FromArgb(226, 232, 240);
    ...
    internal sealed class TokenDialog : Form
    {
        ...
        public TokenDialog(string tunnelId)
        {
            ...
            _btnTest.Region = RoundedRegion(100, 32, 6);
            ...
            _btnOk.Region = RoundedRegion(100, 32, 6);
            ...
            _btnCancel.Region = RoundedRegion(92, 32, 6);
        ...
        private async void BtnTest_Click(object? sender, EventArgs e)
        {
            ...
            _lblStatus.Text = "Testing..."; _lblStatus.ForeColor = Color.FromArgb(100, 116, 139);
            try
            {
                var api = new CloudflareApi(_txtToken.Text.Trim());
                using var cts = new CancellationTokenSource(TimeSpan.FromSeconds(15));
                var tunnel = await api.GetTunnelAsync(_tunnelId, cts.Token);
                _lblStatus.Text = $"✓ Connected to tunnel: {tunnel?.Name ?? _tunnelId}";
        ...
        public async Task RepairAsync()
        {
            ...
            try
            {
                ...
                using (var cts = new CancellationTokenSource(TimeSpan.FromSeconds(30)))
                {
                    ...
                    if (string.IsNullOrWhiteSpace(newToken)) throw new InvalidOperationException("API returned an empty tunnel token.");
